...
/**
 * GUI to make Student from database
 *
 */
public class StudentController {
	// primary stage used in Student
    private Stage stage;
    // list of all Students made in database, used for GUI table
    private ObservableList<Student> students = FXCollections.observableArrayList(StudentDAO.fetchAllStudents());
    // get the database for Students
    StudentDAO studentDAO = new StudentDAO();

    /**
     * constructor for Student GUI
    ...
    public void show() {
        ...
        addBtn.setOnAction(e -> {
            try {
                ...
                if (first.isEmpty() || last.isEmpty() || dob == null) {
                    showAlert("Please fill in all fields: First Name, Last Name, and Birth Date.");
                    return;
                }
            ...
            try {
                ...
                Student existing = students.stream()
                    ...
                    if (existing == null) {
                        ...
                        alert.setTitle("Student ID Not Found");
                        alert.setHeaderText(null);
                        alert.setContentText("Student with ID " + id + " not found.");
                        alert.showAndWait();
                        return;
                    }
